  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        analytics: {
          click: "#8b5cf6", // violet-500
          scroll: "#06b6d4", // cyan-500
      ...
      boxShadow: {
        'heatmap': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
        'heatmap-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
